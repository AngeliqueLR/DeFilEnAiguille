        ...
        <tbody>
            ...
            ?>
                ...
                <tr>
                    ...
                    <td><a class="lienPanier" href = "<?php echo site_url('Visiteur/modifierQteMoins/'.$Produit['rowid'].'/'.$Produit['qty']);?>"><span class = "glyphicon glyphicon-minus-sign"></span> </a><?php echo form_input(array('readonly' => 'readonly','style' => 'border-color: #67a081', 'id' => 'quantitePanier', 'name' => $i.'[qty]', 'value' => $Produit['qty'], 'maxlength' => '3', 'size' => '5')); ?><a class="lienPanier" href = "<?php echo site_url('Visiteur/modifierQtePlus/'.$Produit['rowid'].'/'.$Produit['qty'].'/'.$Produit['option']);?>"><span class = "glyphicon glyphicon-plus-sign"></a></span></td>
