<div class="col-sm-9">
        ...
        ?>
            <label for="txtNomProduit">Nom du produit</label>
                <input required pattern = "[a-zA-ZÀ-ÿ ]*" maxlength = 50 type="input" name="txtNomProduit" value="<?php echo set_value('txtNomProduit'); ?>" /><br/>

            <label for="txtDetailsProduit">Détails de l'article</label>
                <textarea required maxlenght = 300 name="txtDetailsProduit" value="<?php echo set_value('txtDetailsProduit'); ?>"></textarea><br/>

            <label for="txtPrixProduit">Prix HT du produit</label>
                <input required pattern = "[0-9,.]*" maxlength = 5 type="input" name="txtPrixProduit" value="<?php echo set_value('txtPrixProduit'); ?>" /><br/>
            
            <label for="txtTVAProduit">Taux TVA du produit (en %)</label>
                <input required pattern = "[0-9,.]*" maxlength = 5 type="input" name="txtTVAProduit" value="<?php echo set_value('txtTVAProduit'); ?>" /><br/>

            <label for="txtPhotoProduit">Première photo du produit</label>
                <input required pattern = "[a-zA-Z0-9.]*" type="file" accept=".jpg, .JPG, .jpeg" name="txtPhotoProduit" value="<?php echo set_value('txtPhotoProduit'); ?>" /><br/>

            <label for="txtPhotoBisProduit">Deuxième photo du produit</label>
                <input required pattern = "[a-zA-Z0-9.]*" type="file" accept=".jpg, .JPG, .jpeg" name="txtPhotoBisProduit" value="<?php echo set_value('txtPhotoBisProduit'); ?>" /><br/>

            <label for="txtPhotoAccueilProduit">Photo du produit pour le carousel</label>
                <input required pattern = "[a-zA-Z0-9.]*" type="file" accept=".jpg, .JPG, .jpeg" name="txtPhotoAccueilProduit" value="<?php echo set_value('txtPhotoAccueilProduit'); ?>" /><br/>            

            <label for="txtQuantiteProduit">Quantité en stock</label>
                <input required pattern = "[0-9]*" maxlength = 3 type="input" name="txtQuantiteProduit" value="<?php echo set_value('txtQuantiteProduit'); ?>" /><br/>
